...
class GameScenes:
    ...
    def typed_text(self, text, attr=None, speed=.02):#ADJUST TEXT SPEED HERE
        h, w = self.stdscr.getmaxyx()
    ...
    def bedroom(self, bedroom_menu):
        ...
        thought_chunk_one = "Rudely awakened by the sunlight's laser-show on your eyelids, you squint for dear life."
    ...
    def mystery_room(self, question_menu):
        ...
        while True:
            ...
            if chosen_question_option == QuestionChoices.WHO:
                ...
                self.stdscr.clear()
                #Erzrzore, vg'f bsgra gur ynfg xrl va gur ohapu gung bcraf gur ybpx. Qba'g tvir hc. #13
        ...
        while True:
            ...
            if chosen_hallway_option == HallwayChoices.PAINTINGS_LEFT:
                ...
                for observed_thought in [thought_chunk_one, thought_chunk_two, thought_chunk_three, thought_chunk_four]:
                    ...
                    time.sleep(1.4)
                self.stdscr.clear()
                #Mdmzg abmx nwzeizl, vw uibbmz pwe auitt, qa xzwozmaa bweizla gwcz owit. #8
